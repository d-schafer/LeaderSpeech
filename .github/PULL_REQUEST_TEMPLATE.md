...
- [ ] Recorded the source in `data/sources/additional_master_sources.csv` (outbox) — **not** `master_sources.xlsx`, which is researcher-owned (the maintainer sets `recipe_status: validated` on merge)
