...
| `<field>.regex` | no | Pull a substring out of the matched value (e.g. isolate a date from a label). **If it misses, the unfiltered value is returned** — see `regex_required`. |
